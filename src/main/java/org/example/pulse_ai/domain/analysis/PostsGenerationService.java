...
public class PostsGenerationService {
    ...
    private static final String SYSTEM = """
            Ты — копирайтер Telegram-каналов. Пишешь готовые посты под стиль канала.
            ...
            - Финал — призыв к действию или вопрос.
    ...
    private static String buildBatchPrompt(
        ...
        int n = 1;
        for (ContentIdeaEntity idea : ideas) {
            ideaBlock.append(n++).append(". ").append(idea.getTitle()).append('\n');
        }
