...
**Архив ЛС** (текст+медиа+бэкфилл) и join-ops — в коде. Outbound UX ассистента дожат (парсинг→кампания→квота→ответы).  
Дальше: живые парсеры / ad deal. Не релей-бот. Детали — `docs/HANDOFF.md` §7.
